        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            ...
            <input
              ...
              className="bg-white dark:bg-[#030509] border border-slate-300 dark:border-emerald-500/30 rounded-xl pl-8 pr-3 py-1.5 text-xs sm:text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-emerald-500 w-44 sm:w-56 lg:w-64 font-mono-code transition-all"
            />
          </div>
          <button
